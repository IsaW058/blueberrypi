...
class calculate_heading_pid(Node):
    ...
    def set_target_heading(self, msg):
        ...
        target_heading = fix_angle(target_heading)

    def heading_callback(self, msg):

        if self.flag == False:
            self.flag = True
            self.heading_current = fix_angle(msg.data)
    ...
    def calculate_pid(self):
        ...
        error = fix_angle(target_heading-self.heading_current)
        ...
        previous_error = fix_angle(target_heading-self.heading_previous)
